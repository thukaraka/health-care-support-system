...
import 'package:healthcaredecision/pages/HTD/HTD_precaution_details.dart';
...
class HTD_precautions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body:new Column(
        children: <Widget>[
          new GradientAppBar("Precautions",'/home'),
          new Body(),
        ],
      ),
    );
...
List<Precaution> precautions=[
  const Precaution(
    ...
    image1:"assets/images/precaution1.gif",
  ...
  const Precaution(
    ...
    image1:"assets/images/precaution2.gif",
  ...
  const Precaution(
    name:"Eat a heart-healthy diet",
      image1:"assets/images/precaution3.gif",
  ...
  const Precaution(
     ...
     image1:"assets/images/precaution4.gif",
  ...
  const Precaution(
    ...
    image1:"assets/images/precaution5.gif",
  ...
  const Precaution(
    ...
    image1:"assets/images/precaution7.gif",
  ...
  const Precaution(
    ...
    image1:"assets/images/precaution6.gif",
