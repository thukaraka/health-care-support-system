    ...
    return Scaffold(
      ...
      body:new Stack(
          children: <Widget>[new Container(
            ...
            new Container(
           child: GradientAppBar("Heart Disease-symptoms",'/home'),),
           new Container(
  ...
  Entry(
    ...
    <Entry>[
      Entry(
        ...
        <Entry>[
          Entry('Chest pain, chest tightness, chest pressure and chest discomfort (angina).'),
          Entry('Shortness of breath.'),
          Entry('Pain, numbness, weakness or coldness in your legs or arms if the blood vessels in those parts of your body are narrowed.'),
    ...
    <Entry>[
      Entry(
        ...
        <Entry>[
          ...
          Entry('In an infant, shortness of breath during feedings, leading to poor weight gain.'),
        ],
      ),
      Entry(
...
class EntryItem extends StatelessWidget {
  ...
  Widget _buildTiles(Entry root) {
    if (root.children.isEmpty) return
      ListTile(
        title: Text(root.title,textAlign: TextAlign.justify,style: TextStyle(fontSize: 16.0,color: Colors.pink,fontWeight: FontWeight.bold,),),
        leading:Icon(
          Icons.favorite,
          color: Colors.black,
          size: 24.0,
    ...
    return ExpansionTile(
      ...
      title: Text(root.title,textAlign: TextAlign.justify,style: TextStyle(fontSize: 18.0,color: Colors.black,fontWeight: FontWeight.bold,),),
      leading: Icon(
        Icons.favorite,
        color: Colors.pink,
        size: 24.0,
